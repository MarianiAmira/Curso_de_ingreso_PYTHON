...
apellido: Mariani
---
Ejercicio: agilidad_aritmetica_09
---
Enunciado:
...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.operaciones = ["suma", "resta", "multiplicacion"]
        self.operacion = random.choice(self.operaciones)
        self.txt_operador_a.delete(0,10000)
        self.txt_operador_a.insert(0, self.num1)
        self.txt_operador_b.delete(0,10000)
        self.txt_operador_b.insert(0, self.num2)
    ...
    def btn_sumar_on_click(self):
        resultado_ingresado = self.txt_respuesta.get()
        if self.operacion == "suma":
            resultado_correcto = self.num1 + self.num2

        resultado_ingresado = int(resultado_ingresado)
        if resultado_ingresado == resultado_correcto:
            alert(title="Resultado", message="Correcto")
        else:
            alert(title="Resultado", message="Incorrecto")
