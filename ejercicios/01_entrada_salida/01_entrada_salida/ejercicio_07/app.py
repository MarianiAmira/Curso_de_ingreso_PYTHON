...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        resultado_numero= operador_a_int + operador_b_int
        resultado_texto=str(resultado_numero)
        mensaje="El resultado de la suma es: " + resultado_texto
    ...
    def btn_restar_on_click(self):
        ...
        resultado_numero= operador_a_int - operador_b_int
        resultado_texto=str(resultado_numero)
        mensaje="El resultado de la resta es: " + resultado_texto
        alert(title="Restar ", message= mensaje)
    ...
    def btn_multiplicar_on_click(self):
        ...
        resultado_numero= operador_a_int * operador_b_int
        resultado_texto=str(resultado_numero)
        mensaje="El resultado de la multiplicacion es: " + resultado_texto
        alert(title="Multiplicar ", message= mensaje)
    ...
    def btn_dividir_on_click(self):
        ...
        resultado_numero= operador_a_int / operador_b_int
        resultado_texto=str(resultado_numero)
        mensaje="El resultado de la division es: " + resultado_texto
